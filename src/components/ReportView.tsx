...
export const ReportView: React.FC<ReportViewProps> = ({ session, alerts, onClose }) => {
  ...
  const getReportHtml = () => `
      ...
      <body>
        ...
        <div class="footer">
          <p>Generated by Interviewmate-ai AI Proctoring Engine • Neural Net v2.04</p>
  ...
  const handleExportPdf = () => {
    ...
    doc.text('Generated by Interviewmate-ai AI Proctoring Engine • Neural Net v2.04', pageWidth / 2, 280, { align: 'center' });
      ...
      >
        ...
        <div className="p-6 md:p-8 bg-neutral-50 border-t border-neutral-100 flex items-center justify-between">
          <p className="text-xs text-neutral-400">
            This report was auto-generated by Interviewmate-ai neural network.
          </p>
          {isAdmin && (
